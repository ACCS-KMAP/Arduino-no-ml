...
void loop() {
 ...
 /* if(rms_a*100 > 150 and n-prev_n < 10)
  {
    Serial.print("\nFall Detected");
    //digitalWrite(43,LOW);
  }
  if(rms_a*100 < 30 and n-prev_n < 10)
  {
    Serial.print("\nFall Detected");
    //digitalWrite(43,LOW);
  }
...
*/
  ...
  Serial.print("DATA,TIME,"); Serial.print(AccX); Serial.print(","); Serial.print(AccY);Serial.print(","); Serial.print(AccZ);Serial.print(","); Serial.print(GyX);Serial.print(","); Serial.print(GyY);Serial.print(","); Serial.println(GyZ);
